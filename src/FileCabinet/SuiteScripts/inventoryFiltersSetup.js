    ...
    function onRequest(context) {
        if (context.request.method === 'GET') {
          ...
          var fromid =  context.request.parameters.custpage_current_from
			...
			if(fromid==1)
			{
				context.response.write('<script>window.opener.location.href = "https://8760954.app.netsuite.com/app/site/hosting/scriptlet.nl?script=2623&deploy=1&whence=&filters='+JSON.stringify(arr)+'";window.close();</script>')
			}else{
			context.response.write('<script>window.opener.location.href = "https://8760954.app.netsuite.com/app/site/hosting/scriptlet.nl?script=1198&deploy=1&whence=&filters='+JSON.stringify(arr)+'";window.close();</script>')	
			}
