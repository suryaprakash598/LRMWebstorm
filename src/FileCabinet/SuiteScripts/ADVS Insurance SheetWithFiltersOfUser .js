...
function suitelet(request, response){
    ...
    if(request.getMethod()=='GET'){
        ...
        try{
            ...
            var form = nlapiCreateForm('Insurance Sheet', false);
            var fil = [];
            var col = [];
...
//					var cat1='';
                    ...
                    str = str.replace("{1}"," 'insurancesheet' ");
                    str = str.replace("{2}",i);
            ...
            nlapiSetRedirectURL('SUITELET', 'customscript_insurance_claim_dashbaord', 'customdeploy_insurance_claim_dashbaord', null, Param);
