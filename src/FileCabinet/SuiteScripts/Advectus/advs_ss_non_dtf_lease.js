...
define(['N/error', 'N/task', 'N/render', 'N/file', 'N/encode', 'N/record', 'N/search', 'N/ui', 'N/ui/serverWidget', 'N/log', 'N/format', 'N/runtime', 'N/redirect', 'N/url', 'N/https', 'N/xml'],
    function (error, task, render, file, encode, record, search, ui, serverWidget, log, format, runtime, redirect, url, https, xml) {
			...
			//	var recordType = 'customrecord_advs_lease_header';
				...
				var addressComobj = getAddressData(leaseDataObj.companyId);
				log.error('addressobj',addressobj);
				log.error('addressComobj',addressComobj);
				_vinNametext = leaseDataObj.vinName;
				_vinName = _vinNametext.split('');
                           ...
                           /*  var htmlFooter = "";
                            ...
                            html += "<tr>";
                            html += "<td colspan='1' style='border-right: 1px solid black; border-bottom: 1px solid black;'><i>LESSEE</i></td><td colspan='2' style='border-right: 1px solid black; border-bottom: 1px solid black;'> "+leaseDataObj.lesseName+"</td>"; // Moved border styling to 'style' attribute
                            html += "<td colspan='1' style='border-right: 1px; border-bottom: 1px solid black;'><i>CO-LESSEE</i></td><td colspan='2' style='border-right: 1px solid black; border-bottom: 1px solid black;'> "+leaseDataObj.CompanyName+"</td>";
                            html += "</tr>";

                            html += "<tr>";
                            html += "<td colspan='3' style='border-right: 1px solid black; border-bottom: 1px solid black;'><i>ADDRESS:"+addressobj.addressee+"</i></td>";
                            html += "<td colspan='3' style='border-right: 0; border-bottom: 1px solid black;'><i>ADDRESS:"+addressComobj.addressee+"</i></td>";
                            html += "</tr>";

                            html += "<tr>";
                            html += "<td style='border-bottom: 1px solid black;'><i>CITY</i>:"+addressobj.city+"</td>";
                            html += "<td style='border-bottom: 1px solid black;'><i>STATE</i>:"+addressobj.state+"</td>";
                            html += "<td style='border-right: 1px solid black; border-bottom: 1px solid black;'><i>ZIP</i>:"+addressobj.zipcode+"</td>";
                            html += "<td style='border-bottom: 1px solid black;'><i>CITY</i>:"+addressComobj.city+"</td>";
                            html += "<td style='border-bottom: 1px solid black;'><i>STATE</i>:"+addressComobj.state+"</td>";
                            html += "<td style='border-bottom: 1px solid black;'><i>ZIP</i>:"+addressComobj.zipcode+"</td>";
                            html += "</tr>";

                            html += "<tr>";
                            html += "<td><i>CONTACT</i><br/>"+addressobj.email+"</td>";
                            html += "<td><i>PHONE CONTACT</i>:<br/>"+addressobj.email+"</td>";
                            html += "<td style='border-right: 1px solid black;'><i></i></td>";
                            html += "<td><i>CONTACT</i><br/>"+addressComobj.email+"</td>";
                            html += "<td><i>PHONE CONTACT</i>:<br/>"+addressComobj.phone+"</td>";
                            html += "<td><i></i></td>";
                            html += "</tr>";
                            html += "</table>";
                            ...
                            html  += "<tr><td>  Year:<span style='width:10px;'><u>"+leaseDataObj.Year+"</u></span>	Make: <span style='width:10px;'><u>"+leaseDataObj.brand+"</u></span> Model: <u>"+leaseDataObj.model+"</u> Transmission:<u>"+leaseDataObj.transmission+"</u> Color:<u>"+leaseDataObj.excolor+"</u> </td></tr>";
                            html  += "<tr><td>  VEHICLE IDENTIFICATION NUMBER: <u>"+leaseDataObj.vinName+"</u></td></tr>";
                            html += "</table>";
                            ...
                            html  += "<tr><td> $"+leaseDataObj.depoinspection+" Non-refundable deposit <b>PLUS APPLICABLE TAXES </b></td></tr>";
                            html  += "<tr><td>$"+leaseDataObj.payinception+" First Lease Payment <b>PLUS APPLICABLE TAXES </b></td></tr>";
                        
                            html  += "<tr><td></td></tr>";
                            html  += "<tr ><td><b>  Terms: </b>"+leaseDataObj.terms+" </td></tr>";
                            html  += "<tr><td> $"+leaseDataObj.payinception+" Lease Payments <b> PLUS APPLICABLE TAXES</b></td></tr>";
                            html  += "<tr><td>  "+leaseDataObj.terms+" Payment Term in Months</td></tr>";
                            html  += "<tr><td>  "+leaseDataObj.firstdate+" Next Payment Date (after Lease Inceptions) and Frequency (monthly)</td></tr>";
                            html  += "<tr><td>  $"+leaseDataObj.purchopt+" Purchase Option  <b> PLUS APPLICABLE TAXES</b></td></tr>";
                            ...
                            html += "</tr>";
                            html += "<tr>";
                            html += "<td style='border-bottom: 1px solid black;'><i>SIGNATURE (Lessee &amp;  Co-Signer)</i><br/><span>"+leaseDataObj.lesseName+"</span></td>";
                            html += "<td style='border-bottom: 1px solid black;'><i>Title </i><br/><span>"+leaseDataObj.lesseName+"</span></td>";
                            html += "<td style='border-right: 1px solid black; border-bottom: 1px solid black;'><i>Date</i><br/><span>"+leaseDataObj.startdate+"</span></td>";
                            html += "<td style='border-bottom: 1px solid black;'><i>SIGNATURE</i><br/><span>"+leaseDataObj.CompanyName+"</span></td>";
                            html += "<td style='border-bottom: 1px solid black;'><i>Title</i></td>";
                            html += "<td style='border-bottom: 1px solid black;'><i>Date</i><br/><span>"+leaseDataObj.startdate+"</span></td>";
                            html += "</tr>";
                            html +="</table>";
                           // html += "<pbr/>"; //Page one Ends
                            ...
                            html += "<tr style='padding-top: 20px;'><td><u>"+leaseDataObj.startdate+"</u>(the “Principal”), does hereby appoint <b>LRM LEASING COMPANY, INC.,</b> as its true and lawful Attorney-In-Fact (“Attorney-In-Fact”) relating solely to that certain Equipment Lease between the Principal and Attorney-In-Fact (the “Lease”).</td></tr>";
                            html += "<tr style='padding-top: 20px;'><td><b>Lessee hereby irrevocably appoints Lessor as Lessee’s attorney-in-fact to make claim for, receive payment of and execute and endorse all documents, checks or drafts received in payment for loss or damage under any such insurance policy.</b></td></tr></table>";
                           
							html += "<table style='width: 100%;'><tr ><td style='width: 100%;'>Leased Vehicle or Equipment—VIN #, Serial #, or Other Identification</td></tr></table>";
							html += "<table style='width: 100%;'>";
                            html += "<tr ><td>  Year:</td><td><u>"+leaseDataObj.Year+"</u></td>	<td>Make:</td><td> <u>"+leaseDataObj.brand+"</u></td><td>Model:</td><td> <u>"+leaseDataObj.model+"</u> </td><td>Transmission:</td><td><u>"+leaseDataObj.transmission+"</u> </td><td>Color:</td><td><u>"+leaseDataObj.excolor+"</u> </td></tr></table>";
							
                            html += "<table style='width: 100%;'><tr><td style='border-bottom: 1px solid black;'>VEHICLE IDENTIFICATION NUMBER:</td></tr>";
                            html += "<tr><td style='border-bottom: 1px solid black;'>"+leaseDataObj.vinName+"</td></tr></table>";
                            html += "<table><tr style='padding-top: 20px;'><td>Further, the Principal does ratify and confirm all actions authorized hereunder that its Attorney-In-Fact shall do or cause to be done by virtue of this Power of Attorney. Except as for the power herein stated, the Principal does not authorize its Attorney-In-Fact to act for any other purpose.</td></tr>";
                            ...
                            html += "<tr style='padding-top: 20px;'><td>IN WITNESS WHEREOF, the Principal has hereunto executed and delivered this Power of Attorney this date of <u>"+leaseDataObj.startdate+"</u></td></tr>";
                            html += "<tr style='padding-top: 20px;'><td>Name: <u>"+leaseDataObj.lesseName+"</u></td></tr>";
                            html += "<tr style='padding-top: 10px;'><td>STATE of Florida</td></tr>";
                            html += "<tr style='padding-top: 10px;'><td>COUNTRY of US </td></tr>";
                            html += "<tr style='padding-top: 10px;'><td>On Date:<u>"+leaseDataObj.startdate+"</u>, before me, the undersigned, personally appeared <u>"+leaseDataObj.lesseName+"</u>, personally known to me or proved to me on the basis of satisfactory evidence to be the individual(s) whose name(s) is (are) subscribed to the within instrument and acknowledged to me that he/she/they executed the same in his/her/their capacity(ies), that by his/her/their signature(s) on the instrument, the individual(s), or the person upon behalf of which the individual(s) acted, executed the instrument, and that such individual made such appearance before the undersigned in the City of "+addressobj.city+", State of Florida.</td></tr>";
                            ...
                            html += "<tr style='padding-top: 20px;'><td>This letter authorizes the lessee, "+leaseDataObj.lesseName+" to register the following vehicle.</td></tr></table>";
                            ...
                            html += "<tr style='padding-top: 10px;'><td>  Year:<span style='width:10px;'><u>"+leaseDataObj.Year+"</u></span>	Make: <span style='width:10px;'><u>"+leaseDataObj.brand+"</u></span> Model: <u>"+leaseDataObj.model+"</u> Transmission:<u>"+leaseDataObj.transmission+"</u> Color:<u>"+leaseDataObj.excolor+"</u> </td></tr>";
                            html += "<tr><td>  VEHICLE IDENTIFICATION NUMBER: <u>"+leaseDataObj.vinName+"</u></td></tr>";
                             */
							html += "<table style='width: 100%;'>";
							
                        html += "<tr><td style='font-size: 14px;align: center;'>Leased Vehicle or Equipment—VIN #, Serial #, or Other Identification</td></tr>";
                        html  += "<tr><td>  Year:<u>"+leaseDataObj.Year+"</u>	Make: <u>"+leaseDataObj.brand+"</u> Model: <u>"+leaseDataObj.model+"</u> Transmission:<u>"+leaseDataObj.transmission+"</u> Color:<u>"+leaseDataObj.excolor+"</u> </td></tr>";
                        html  += "<tr><td border-bottom = '1px'>  VEHICLE IDENTIFICATION NUMBER:"+leaseDataObj.vinName+"</td></tr>";
						html += "</table>";
							
							html += "<table><tr style='padding-top: 40px;'><td><b><u>LRM Leasing Company Inc. must always remain as the sole registered owner of the title.</u></b></td></tr>";
                            ...
                            html += "<tr style='padding-top: 50px;'><td>"+leaseDataObj.lesseName+"</td></tr>";
                            ...
                            html += "<tr><td>IN WITNESS WHEREOF, the Principal has hereunto executed and delivered this Power of Attorney this Date: "+leaseDataObj.startdate+"</td></tr>";
                            html += "<tr><td style='padding-top:10px;'>Name: "+leaseDataObj.lesseName+"</td></tr>";
                            html += "<tr><td>STATE of Florida</td></tr>";
                            html += "<tr><td>COUNTRY of US </td></tr>";
                            html += "<tr><td>On Date: "+leaseDataObj.startdate+" in the year 202_, before me, the undersigned, personally appeared "+leaseDataObj.lesseName+", personally known to me or proved to me on the basis of satisfactory evidence to be the individual(s) whose name(s) is (are) subscribed to the within instrument and acknowledged to me that he/she/they executed the same in his/her/their capacity(ies), that by his/her/their signature(s) on the instrument, the individual(s), or the person upon behalf of which the individual(s) acted, executed the instrument, and that such individual made such appearance before the undersigned in the City of ______________________________________, State of Florida.</td></tr>";
                            ...
                            html += "<tr><td style='padding-top:10px;'>This Agreement shall be signed on behalf of LRM by "+leaseDataObj.CompanyName+", and on behalf of the Lessee by "+leaseDataObj.lesseName+", and effective as of the date first written above.</td></tr>";
                           ...
                           /*  html += "<table style='width: 100%; font-family: Arial Narrow, Arial, sans-serif; border: 1px solid black; margin-top: 10mm; font-size: 11.3px; border-collapse: collapse;'>"; // Added 'border-collapse' for proper border styling
                            ...
                            html  += "<tr><td  font-size='14px'   style='align: center;'><b>OF VEHICLE PROTECTION SYSTEM (“AGREEMENT”)</b></td></tr></table>";
                       ...
                       // html +="<p style='font-size: 14px;'>VEHICLE IDENTIFICATION NUMBER:<b> _____________________________________________</b></p>";
						...
						html += "</table>";
							...
							html+= "<table><tr style='padding-top: 10px;'><td>I have agreed to lease the above-described vehicle. You are leasing the vehicle.  You do not own it.  Your right to possession and use of the Vehicle is conditioned on you making timely lease payments to Lessor and complying with the terms of the Lease (“Lease”).  </td></tr>";
                       ...
                       /*  html += '<table style="width: 100%; border-collapse: collapse;font-size: 8px;">';
                        ...
                        html += "<table  font-size='12px'  style=' width: 100%; font-family: Arial Narrow, Arial, sans-serif; text-align: center;' margin-top= '10mm'  >";
                        html  += "<tr><td  font-size='13px'   align=' center'><b>TRAC ADDENDUM</b></td></tr>";
                        html  += "<tr><td  font-size='13px'   align='center'><b>MOTOR VEHICLE LEASE AGREEMENT</b></td></tr>";
               ...
               function searchForLeaseData(leaseid)
			{
				try{
					...
					customrecord_advs_lease_headerSearchObj.run().each(function(result){
					   ...
					   obj.vinName        = result.getText({name:'custrecord_advs_la_vin_bodyfld'});
					   obj.lesseId        = result.getValue({name:'custrecord_advs_l_h_customer_name'});
					   obj.lesseName      = result.getText({name:'custrecord_advs_l_h_customer_name'});
					   obj.companyId      = result.getValue({name:'custrecord_advs_lease_comp_name_fa'});
					   obj.CompanyName    = result.getValue({name:'custrecord_advs_lease_comp_name_fa'});
					   obj.actualAddress  = result.getValue({name:'custrecord_advs_l_h_act_add'});
					   obj.companyAddress = result.getValue({name:'custrecord_advs_l_h_addr_drive_lice'});
					   obj.email          = result.getValue({name:'custrecord_advs_l_h_email'});
					   obj.startdate      = result.getValue({name:'custrecord_advs_l_h_start_date'});
					   
					   obj.enddate        = result.getValue({name:'custrecord_advs_l_h_end_date'});
					  
					   
					   obj.terms        = result.getValue({name:'custrecord_advs_l_h_terms'});
					   obj.depoinspection        = result.getValue({name:'custrecord_advs_l_h_depo_ince'});
					   obj.payinception        = result.getValue({name:'custrecord_advs_l_h_pay_incep'});
					   obj.firstdate        = result.getValue({name:'custrecord_advs_l_a_pay_st_date'});
					   obj.purchopt        = result.getValue({name:'custrecord_advs_l_h_pur_opti'});
					   obj.driverlicense        = result.getValue({name:'custrecord_include_driver_license'});
					   
					   
					   obj.brand          = result.getText({name: "custrecord_advs_vm_vehicle_brand",join: "CUSTRECORD_ADVS_LA_VIN_BODYFLD"});
					   obj.Year	          = result.getText({name: "custrecord_advs_vm_engine_model_year",join: "CUSTRECORD_ADVS_LA_VIN_BODYFLD"})||'';
					   obj.transmission   = result.getText({name: "custrecord_advs_vm_transmission_type",join: "CUSTRECORD_ADVS_LA_VIN_BODYFLD"});
					   obj.model          = result.getText({name: "custrecord_advs_vm_model",join: "CUSTRECORD_ADVS_LA_VIN_BODYFLD"});
					   obj.excolor        = result.getText({name: "custrecord_advs_vm_exterior_color",join: "CUSTRECORD_ADVS_LA_VIN_BODYFLD"});
					   obj.bucket         = result.getText({name: "custrecord_vehicle_master_bucket",join: "CUSTRECORD_ADVS_LA_VIN_BODYFLD"});
					   return true;
					});
				return obj;
			...
			{
				log.error('getAddressData',getAddressData);
				var obj={};
				 var  state = '';
                        obj.state = ''; 
                        obj.addressee = ''; 
					...
					var customerDetailsSearch = search.create({
                        ...
                        filters: [
                             [
								...
								"OR",
								[["companyname","contains",Lessee],"OR",["entityid","haskeywords",Lessee]]
							  
							]
                        ],
                        columns: [
                            search.createColumn({name: "phone", label: "Addressee"}),
                            search.createColumn({name: "email", label: "Addressee"}),
                            ...
                            search.createColumn({name: "country", label: "Zip Code"})
                        ]
                    });
