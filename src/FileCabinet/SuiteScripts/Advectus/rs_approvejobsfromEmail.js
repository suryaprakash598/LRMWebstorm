...
define(['N/runtime', 'N/task', 'N/record', 'N/search', 'N/log'], function(
  ...
  function onGet(requestParams) {
    // return string or object data
	record.submitFields({type:'estimate',id:requestParams.estid,values:{custbody_approve_reject_data:JSON.stringify(requestParams.arr)},options:{enableSourcing:!1,ignoreMandatoryFields:!0}});
    return '1';
  }
