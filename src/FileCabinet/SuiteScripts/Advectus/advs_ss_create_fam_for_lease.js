    ...
    (currency, email, format, record, runtime, search, serverWidget) => {
        ...
        const onRequest = (scriptContext) => {
            ...
            if(request.method == "GET"){
                var leaseid   =   request.parameters.custparam_id;

                var FieldsLook = ["custrecord_advs_l_h_location",
                    "custrecord_advs_l_h_customer_name", "custrecord_advs_la_vin_bodyfld","custrecord_advs_l_h_start_date"];
                ...
                if (RentalObj['custrecord_advs_la_vin_bodyfld'] != null && RentalObj['custrecord_advs_la_vin_bodyfld'] != undefined) {
                    VehicleID = RentalObj['custrecord_advs_la_vin_bodyfld'][0].value;
                }

                var leaseStart  = RentalObj['custrecord_advs_l_h_start_date'];
                ...
                datefldObj.defaultValue = convleaseStart;
                ...
                var leasefldObj  =   form.addField({
                    id:"custpage_leaseid",
                    type:"select",
                    label:"Lease #",
                    source:"customrecord_advs_lease_header"
                });
                leasefldObj.updateDisplayType({displayType:"hidden"});
                leasefldObj.defaultValue = leaseid;
...
//                    });
                ...
                var leaseID = request.parameters.custpage_leaseid;


                var FieldsLook = ["custrecord_advs_la_vin_bodyfld","custrecord_advs_l_h_terms",
                ...
                var VehicleID = "";var terms = "";var leaseStart = "";
                if (RentalObj['custrecord_advs_la_vin_bodyfld'] != null && RentalObj['custrecord_advs_la_vin_bodyfld'] != undefined) {
                    VehicleID = RentalObj['custrecord_advs_la_vin_bodyfld'][0].value;
                }
                terms  = RentalObj['custrecord_advs_l_h_terms'];
                terms   =terms*1;

                leaseStart  = RentalObj['custrecord_advs_l_h_start_date'];
                ...
                try {
                    ...
                    if(leaseID){
                        record.submitFields({
                            ...
                            id:leaseID,
                            values:{
                                "custrecord_advs_l_h_fixed_ass_link":assetId
                            }
                        });
                    }
