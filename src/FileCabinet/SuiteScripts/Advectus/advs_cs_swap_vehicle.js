...
function(currentRecord,url,https) {
    ...
    function fieldChanged(scriptContext) {
		  ...
		  var LineCount	=	curRec.getLineCount({sublistId:'custpage_sublist'});
            if(Sublistname == "custpage_sublist" && fieldId == "cust_select_veh_card"){
                for(var line=1;line <=LineCount; line++){	
                    if(LineNum != line){
                    curRec.setSublistValue({ sublistId: 'custpage_sublist', fieldId: 'cust_select_veh_card', line: line, value: false });
                    }
                }
            }
    }
