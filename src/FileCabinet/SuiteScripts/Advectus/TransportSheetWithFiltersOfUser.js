...
function suitelet(request, response){
    ...
    if(request.getMethod()=='GET'){
        ...
        try{
            ...
            var form = nlapiCreateForm('Transport Sheet', false);
            var fil = [];
            var col = [];

            fil.push(new nlobjSearchFilter('internalid', null, 'is', _empid));
            col.push(new nlobjSearchColumn('custentity_tran_filters_chosen'));
...
//					var cat1='';
                    ...
                    str = str.replace("{1}"," 'inventorysheet' ");
                    str = str.replace("{2}",i);
                ...
                str = str.replace("{1}"," 'transportsheet' ");
            ...
            nlapiSetRedirectURL('SUITELET', 'customscript_advs_transport_dashboard', 'customdeploy_advs_transport_dashboard', null, Param);
