    ...
    function (error, task, render, file, encode, record, search, ui, serverWidget, log, format, runtime, redirect, url, https, xml) {
        ...
        function onRequest(context) {
			...
			//	var recordType = 'customrecord_advs_lease_header';
                ...
                var VIN = VinNo.split("");
                var Customer = RecObj.getText({
                    fieldId: "custrecord_advs_l_h_customer_name"
                });
                var CustomerID = RecObj.getValue({
                    fieldId: "custrecord_advs_l_h_customer_name"
                });
                var CustomerCompany = RecObj.getValue({
                    fieldId: "custrecord_advs_lease_comp_name_fa"
                });
                var CustomerCompanyText = RecObj.getValue({
                    fieldId: "custrecord_advs_lease_comp_name_fa"
                });
                var SchedNoOfPayment = RecObj.getValue({
                    fieldId: "custrecord_advs_l_h_terms"
                });
                var securityDeposit =RecObj.getValue({
                    fieldId:"custrecord_advs_l_h_security_dep"
                })
                var date = RecObj.getValue({
                    fieldId: "custrecord_advs_l_h_start_date"
                });
                ...
                var downPayment = RecObj.getValue({
                    fieldId: "custrecord_advs_l_h_depo_ince"
                });
                ...
                var customrecord_advs_flexi_lease_scheduleSearchObj = search.create({
                    ...
                    //         ["isinactive","is","F"],
                    //         "AND",
                    //         ["custrecord_advs_f_l_s_cnt_head","anyof","46"],
                    //         "AND",
                    //         ["custrecord_advs_f_l_s_cnt_head.custrecord_advs_l_h_start_date","on","12/18/2023"]
                    //     ],
                    columns:
                        [
                            search.createColumn({
               ...
               // log.debug("customrecord_advs_flexi_lease_scheduleSearchObj result count",searchResultCount);
                ...
                var SearchOnCoLesseCustomer = search.create({
                    ...
                    filters:
                        [
                            ...
                            // ["internalid", "anyof", CustomerCompany]
                            ["companyname", "is", CustomerCompany]
                        ],
                    columns:
                        [
                ...
                SearchOnCoLesseCustomer.run().each(function (result) {
					log.debug('colessid',result.getValue({name: "internalid"}));
                    coLesseEmail = result.getValue({ name: "email" });
                    coLessePhone = result.getValue({ name: "phone" });
                    coLesseCountry = result.getValue({
                        name: "country",
                        join: "Address"
                    });
                    coLesseCity = result.getValue({
                        name: "city",
                        join: "Address"
                    });
                    coLesseCountryCode = result.getValue({
                        name: "countrycode",
                        join: "Address"
                    });
                    coLessezipcode = result.getValue({
                        name: "zipcode",
                        join: "Address"
                    });
                    coLesseState = result.getValue({
                        name: "state",
                        join: "Address"
                    });
                    coLesseAddressee = result.getValue({
                        name: "addressee",
                        join: "Address"
                    });
                ...
                htmlHeader += "<table   width='95%'>" +
                    "<tr>" +
                    "<td>" +
                    "<table  style='margin-left:20px'  align='left' height='7'>" +
                    "<tr >" +
                    " <td ><img src ='" + Imagewith1980 + "' align='center' width='130px' height='75px' margin-top='8px' alt='Logo cannot loaded'></img></td>" +
                    "</tr>" +
                    "</table>" +
                    "</td>" +
                    "<td></td>" +
                ...
                Html += "<table align='center' width='95%' margin-top='7' >" +
                    "<tr style='font-size:12px'>" +
                    "<td  border-collapse = 'collapse' border-right ='.25' border-left ='.25' border-top ='.25'   >" +
                    "<table width='100%'>" +
                    "<tr style='font-size:9px' ><td>Lessee</td></tr>" +
                    "<tr><td>" + Customer + "</td></tr>" +
                    "</table>" +
                    "</td>" +
                    "<td border-collapse = 'collapse'   border-right ='.25' border-top ='.25'>" +
                    "<table width='100%'  >" +
                    "<tr style='font-size:9px' ><td>Co Lessee</td></tr>" +
                    "<tr><td>" + CustomerCompanyText + "</td></tr>" +
                    "</table>" +
                    "</td>" +
                    "</tr>" +
                    "<tr style='font-size:12px'>" +
                    "<td  border-collapse = 'collapse' border-right ='.25' border-left ='.25' border-top ='.25'   >" +
                    "<table width='100%'>" +
                    "<tr style='font-size:9px' ><td>ADDRESS</td></tr>" +
                    "<tr><td>"+Addressee+"</td></tr>" +
                    "</table>" +
                    "</td>" +
                    "<td border-collapse = 'collapse'   border-right ='.25' border-top ='.25'>" +
                    "<table width='100%'  >" +
                    "<tr style='font-size:9px' ><td>ADDRESS</td></tr>" +
                    "<tr><td>"+coLesseAddressee+"</td></tr>" +
                    "</table>" +
                    "</td>" +
                    "</tr>" +
                    "<tr style='font-size:12px'>" +
                    "<td  border-collapse = 'collapse' border-right ='.25' border-left ='.25' border-top ='.25'   >" +
                    "<table width='100%'>" +
                    "<tr style='font-size:9px' ><td>CITY</td><td>STATE</td><td>ZIP</td></tr>" +
                    ...
                    "<table width='100%'  >" +
                    "<tr style='font-size:9px' ><td>CITY</td><td>STATE</td><td>ZIP</td></tr>" +
                    "<tr><td>"+coLesseCity+"</td><td>"+coLesseState+"</td><td>"+coLessezipcode+"</td></tr>" +
                    "</table>" +
                    "</td>" +
                    "</tr>" +
                    "<tr style='font-size:12px'>" +
                    ...
                    "<table width='100%'>" +
                    "<tr style='font-size:9px' ><td>CONTACT</td><td>PHONE CONTACT</td></tr>" +
                    ...
                    "<table width='100%'  >" +
                    "<tr style='font-size:9px' ><td>CONTACT</td><td>PHONE CONTACT</td></tr>" +
                    "<tr><td>" + coLesseEmail + "</td><td>" + coLessePhone + "</td></tr>" +
                    "</table>" +
                    "</td>" +
                    "</tr>" +
                ...
                Html += "<table align='center' width='95%' padding-top='20px' >" +
                    "<tr width = '100%' style='font-size:10px'>" +
                    "<td width = '5%' border-collapse = 'collapse' border-right ='.25' border-left ='.25' border-top ='.25' border-bottom ='.25'></td>" +
                    "<td  width = '95%' border-collapse = 'collapse' border-right ='.25' border-left ='.25' border-top ='.25' border-bottom ='.25' align = 'center'>EQUIPMENT - MODEL #, CATALOG #, OR OTHER IDENTIFICATION</td>" +
                    "</tr>" +
                    "</table>";

                Html += "<table align='center' width='95%'  >" +
                    "<tr width = '100%'>" +
                    "<td  style='font-size:8px'  border-collapse = 'collapse'  border-left ='.25'  border-bottom ='.25'>Year:</td><td  style='font-size:10px'  border-collapse = 'collapse' border-right ='.25'   border-bottom ='.25'>" + Year + "</td>" +
                    "<td  style='font-size:8px'  border-collapse = 'collapse'    border-bottom ='.25'>Make:</td><td  style='font-size:10px'  border-collapse = 'collapse' border-right ='.25'   border-bottom ='.25'>" + Brand + "</td>" +
                    "<td style='font-size:8px'  border-collapse = 'collapse'    border-bottom ='.25'>Model:</td><td  style='font-size:10px'  border-collapse = 'collapse' border-right ='.25'   border-bottom ='.25'>" + Model + "</td>" +
                    "<td style='font-size:8px'  border-collapse = 'collapse'   border-bottom ='.25'>Transmission:</td><td  style='font-size:10px'  border-collapse = 'collapse' border-right ='.25'   border-bottom ='.25'>"+Type+"</td>" +
                    "<td style='font-size:8px'  border-collapse = 'collapse'    border-bottom ='.25'>Color:</td><td  style='font-size:10px'  border-collapse = 'collapse' border-right ='.25'   border-bottom ='.25'>"+ModelClr+"</td>" +
                    "</tr>" +
                    "</table>";
                ...
                Html += "<table style='font-size:11px' align='center' width='95%' >" +
                    "<tr>" +
                    "<td  align='center'  border-collapse = 'collapse'    border-bottom ='.25' border-left ='.25' border-right ='.25'>VEHICLE IDENTIFICATION NUMBER</td>" +
                    "</tr>" +
                    "</table>";

                Html += "<table style='font-size:10px' align='center' width='95%' >" +
                    "<tr>";

                for (var i = 0; i < VIN.length; i++) {

                    if (i == 0) {
                        Html += "<td  align='center'  border-collapse = 'collapse'    border-bottom ='.25' border-left ='.25' border-right ='.25'>" + VIN[i] + "</td>";
                    } else {
                        Html += "<td  align='center'  border-collapse = 'collapse'    border-bottom ='.25'  border-right ='.25'>" + VIN[i] + "</td>";
                    }
                ...
                Html += "<table style='font-size:10px' align='center' border='.25' border-bottom ='0' width='95%' margin-top='20px' >" +
                    "<tr>" +
                    "<td  width='20%'> " +
                    "<table>" +
                    "<tr>" +
                    "<td style='font-size:9px' align='left'>Inceptions:</td>" +
                    "</tr>" +
                    "<tr>" +
                    "<td style='font-size:10px' align='left'><u>$"+downPayment+"</u></td>" +
                    "</tr>" +
                    "<tr>" +
                    "<td style='font-size:10px' align='left'><u>$"+firstPaymentValue+"</u></td>" + // Value from Flexi schedule
                    "</tr>" +   
                    "</table>" +
                    "</td>" +
                    ...
                    "<tr>" +
                    "<td style='font-size:10px'>Non-refundable deposit <b>PLUS APPLICABLE TAXES</b></td>" +
                    "</tr>" +
                    "<tr>" +
                    "<td style='font-size:10px'>First Lease Payment <b>PLUS APPLICABLE TAXES</b></td>" +
                    "</tr>" +
                    "<tr>" +
                    "<td ></td>" +
                    "</tr>" +
                    ...
                    "<table>" +
                    "<tr >"+
                    "<td><p  style='font-size:13px' >$<u>"+securityDeposit+"</u>for the initial deposit (plus any applicable sales tax)  will be  paid via ACH on <u>"+startdate+"</u></p></td>"+
                    "</tr>"+
                    "<tr>" +
                    "<td></td>" +
                    "</tr>" +
                    ...
                    "<table style='font-size:10px' align='center' width='95%' border-top ='0' border-bottom ='.25' border-right ='.25' border-left ='.25' >"+
                  "<tr>"+
                  "<td  width='54%'></td>"+
                "<td style='font-size:10px; width: 100%;'> Nonrefundable Deposit is: 1) payable at lease signing and non-refundable, 2) held for performance under the terms of this agreement, shall not bear interest, 3) may be applied by Lessor to any of your obligations hereunder or any default, and 4) applied to Lease Payments for up to the number of months of the Extension Period, as provided herein. First Lease Payment is payable at lease signing and non-refundable.</td>"+
                 "</tr>"+
                    "</table>";


                Html += "<table style='font-size:10px' align='center' border-bottom ='.25' border-right ='.25' border-left ='.25' width='95%'>" +
                    "<tr>" +
                    "<td  width='25%'> " +
                    "<table>" +
                    "<tr>" +
                    "<td style='font-size:9px' align='left'>Payment Term:</td>" +
                    "</tr>" +
                    "<tr>" +
                    "<td style='font-size:13px' align='left'><u>" + SchedNoOfPayment + "</u></td>" +
                    "</tr>" +
                    "</table>" +
                    "</td>" +
                    "<td width='85%' >" +
                ...
                var regalurpaymentleasedatas=search.create({
                      ...
                      [
                        search.createColumn({
                                             name: "custrecord_advs_lm_lc_c_narration",
                                            sort: search.Sort.ASC,
                                            label: "NARRATION"  }),
        ...
        var firstDateWithoutInvoice = findFirstDateWithoutInvoice(nextpayment);
            ...
            if (firstDateWithoutInvoice) {
               ...
               log.error("No date without an invoice found.");
                ...
                // });
                // var searchResultCount = customrecord_advs_flexi_lease_scheduleSearchObj.runPaged().count;
                // log.error("customrecord_advs_flexi_lease_scheduleSearchObj result count",searchResultCount);
                // customrecord_advs_flexi_lease_scheduleSearchObj.run().each(function(result){
                //     var serialNumber = result.getValue({  name: "id", sort: search.Sort.ASC });
                //     var scheduleNumber = result.getValue({  name: "custrecord_advs_f_l_s_schedules"});
                //     var amount = result.getValue({  name: "custrecord_advs_f_l_s_amount"});
                //     var obj = {}
                ...
                // var startNumber = 1
                // var endNumber = 0
                // for (let i = 0; i < leaseScheduleArrayData.length; i++) {
                //     var currentData = leaseScheduleArrayData[i];
                //     var endID = currentData.scheduleNumber;
                //     var amount = currentData.amount;
                //     var obj = {}
                //     if(i == 0){
                //         obj.startNumber = startNumber
                //         obj.endNumber =(endID*1)
                //         startNumber = (endID*1)+1
                //     }else{
                //         endNumber = (startNumber*1)+(endID*1)-1
                //         obj.startNumber = (startNumber*1)
                //         obj.endNumber = (endNumber*1)
                ...
                //     var amount = currentData.amount
                //     Html +=  "<p> Lease payment during months : "+startNumber+"-"+endNumber+" Amount "+ amount+"</p>" ;
                // }
                ...
                Html += "<table style='font-size:10px' align='center' border='.25' width='95%' margin-top='5px' >" +
                    "<tr><td>Purchase option price:</td></tr>" +
                    "<tr>" +
                    "<td> " +
                    "<table>" +
                    "<tr>" +
                    "<td style='font-size:10px' align='left'>$<u>"+PurchaseOpt+"</u></td>" +
                    "</tr>" +
                ...
                Html += "<table  align='center'  width='95%' margin-top='5px' >" +
                    "<tr><td  style='font-size:12px'  align='center' border-top='.25' border-right='.25' border-left='.25' border-bottom ='.25' >LEASE</td></tr>" +
                    "<tr>" +
                    "<td style='font-size:8px'  border-right='.25' border-left='.25' border-bottom ='.25' >This Motor Vehicle Lease Agreement (this “Lease”) is written in plain English as a convenience to you. References to “you” or “your” are to the Lessee. References to “us,” “we” or “our” are to the Lessor, LRM Leasing Company, Inc. <b> DO NOT SIGN IF YOU HAVE NOT READ OR DO NOT UNDERSTAND THIS LEASE.</b> You agree to all the terms and conditions shown on this first page hereof and the Additional Terms and Conditions set forth on the attached pages,<br/> Lessor is leasing the Equipment to Lessee “AS-IS.” LESSEE ACKNOWLEDGES THAT LESSOR DOES NOT MANUFACTURE THE EQUIPMENT, LESSOR DOES NOT REPRESENT THE MANUFACTURER OR THE SUPPLIER, AND LESSEE HAS SELECTED THE EQUIPMENT AND SUPPLIER BASED UPON LESSEE'S OWN JUDGMENT. LESSOR MAKES NO WARRANTIES, EXPRESS ORIMPLIED, NOR WARRANTIES OF MERCHANTABILITY OR FITNESS FOR A PARTICULAR PURPOSE. LESSEE AGREES THAT REGARDLESS OF CAUSE, LESSOR IS NOT RESPONSIBLE FOR AND LESSEEWILL NOT MAKE ANY CLAIM AGAINST LESSOR FOR ANY DAMAGES, WHETHER CONSEQUENTIAL, DIRECT, PUNITIVE, SPECIAL, OR INDIRECT. SO LONG AS LESSEE HAS NOT SUFFERED ANEVENT OF DEFAULT, Lessor transfers to Lessee for the term of this Lease any warranties made by the manufacturer or Supplier under a Supply Contract. LESSEE AGREES THAT LESSOR IS NOT THE SUPPLIER OR MANUFACTURER OF THE EQUIPMENT. <br/> FURTHER, LESSEE AGREES THAT THIS IS A FINANCE LEASE AS SUCH TERM IS DEFINED IN ARTICLE 2A OF THE UNIFORM COMMERCIAL CODE AND NOTWITHSTANDING ANY DETERMINATION TO THE CONTRARY, LESSOR SHALL HAVE ALL RIGHTS AND BENEFITS OF A LESSOR UNDER A FINANCE LEASE.</td>" +
                    "</tr>" +
                    "</table>";
                ...
                Html += "<table align='center' width='95%' margin-top='10' >" +
                    ...
                    "<td  border-collapse = 'collapse' border-right ='.25' border-left ='.25' border-top ='.25'   >" +
                    "<table width='100%'>" +
                    "<tr style='font-size:9px' ><td>LESSEE (Authorized Agent or as Individual) &amp; Co-Signer</td></tr>" +
                    "<tr><td>" + Customer + "</td></tr>" +
                    "</table>" +
                    "</td>" +
                    "<td border-collapse = 'collapse'   border-right ='.25' border-top ='.25'>" +
                    "<table width='100%'  >" +
                    "<tr style='font-size:9px' ><td>LESSOR</td></tr>" +
                    "<tr><td></td></tr>" +
                    "</table>" +
                    "</td>" +
                    "</tr>" +
                    ...
                    "<td  border-collapse = 'collapse' border-right ='.25' border-left ='.25' border-top ='.25'   border-bottom ='.25' >" +
                    "<table width='100%'>" +
                    "<tr style='font-size:8px' ><td>SIGNATURE (Lessee &amp; Co-Signer)</td><td>Title</td><td>Date</td></tr>" +
                    ...
                    "<td  border-collapse = 'collapse' border-right ='.25' border-left ='.25' border-top ='.25' border-bottom ='.25'   >" +
                    "<table width='100%'>" +
                    "<tr style='font-size:8px' ><td>SIGNATURE</td><td>Title</td><td>Date</td></tr>" +
                    "<tr><td style='font-size:4.7px' padding-top='-5px'>DocuSignedBy:</td><td style='font-size:10px'>DIRECTOR</td><td style='font-size:10px'>" + currentdate + "</td></tr>" +
                ...
                Html += "<table style='font-size:13px;margin-top:-5px;' align='center;' width='95%' >" +
                    "<tr>" +
                ...
                Html += "<table align='center' width='95%' padding-top='20px' >" +
                    ...
                    "<td   border-collapse = 'collapse' border-right ='.25' border-left ='.25' border-top ='.25' border-bottom ='.25' align = 'center'>EQUIPMENT - MODEL #, CATALOG #, OR OTHER IDENTIFICATION</td>" +
                    "</tr>" +
                    "</table>";
                ...
                Html += "<table style='font-size:12px' align='center' width='95%' padding-top='20px' >" +
                    "<tr>" +
                    "<td  align='center'  border-collapse = 'collapse'  border-top='.25'  border-bottom ='.25' border-left ='.25' border-right ='.25'>VEHICLE IDENTIFICATION NUMBER</td>" +
                    "</tr>" +
                    "</table>";
                ...
                Html += "<table style='font-size:13px' align='center' width='95%' >" +
                    "<tr>" +
                    "<td align='center' style='color:red;'><mark>*Do not register in LRM Leasing Company Inc.'s name*</mark></td>" +
                    "</tr>" +
                    "</table>";
                ...
                Html += "<table align='center' width='95%' padding-top='10px' >" +
                    "<tr width = '100%' style='font-size:12px'>" +
                    "<td   border-collapse = 'collapse' border-right ='.25' border-left ='.25' border-top ='.25' border-bottom ='.25' align = 'center'>EQUIPMENT - MODEL #, CATALOG #, OR OTHER IDENTIFICATION</td>" +
                    "</tr>" +
                    "</table>";
                ...
                Html += "<table align='center' width='95%' margin-top='10' >" +
                    ...
                    "<td  border-collapse = 'collapse' border-right ='.25' border-left ='.25' border-top ='.25'   >" +
                    "<table width='100%'>" +
                    "<tr style='font-size:9px' ><td>Guarantor Signature</td></tr>" +
                    ...
                    "<td  border-collapse = 'collapse' border-right ='.25' border-left ='.25' border-top ='.25'   border-bottom ='.25' >" +
                    "<table width='100%'>" +
                    "<tr style='font-size:8px' ><td>Guarantor Print Name</td><td>Date</td></tr>" +
                    "<tr><td>" + Customer + "</td></tr>" +
                ...
                Html += "<table style='font-size:14px' align='center' width='95%' >" +
                    "<tr>" +
                ...
                var LRMLASearchObj = search.create({
                    ...
                    columns:
                        [
                            search.createColumn({
                                name: "custrecord_advs_heading",
                                label: "HEADING"
                            }),
                            search.createColumn({
                                name: "custrecord_advs_data",
                                label: "DATA"
                            }),
                            search.createColumn({
                                name: "internalid",
                ...
                LRMLASearchObj.run().each(function (result) {
                    ...
                    Html += "<table style='font-size:12px' align='center' width='90%' padding-top='20' >" +
                        "<tr>" +
                ...
                Html += "<table style='font-size:12px' align='center' width='95%' padding-top='20' >" +
                    "<tr>" +
                    "<td >" +
                ...
                Html += "<table style='font-size:13px' align='center' width='95%' padding-top='10px'>" +
                    "<tr>" +
                    "<td style='font-size:7px' border-left='.25' border-right='.25' border-top='.25' >LESSEE (Authorized Agent or as Individual) &amp; Co-Signer PRINT NAME </td>" +
                    "</tr>" +
                    "<tr>" +
                    "<td style='font-size:11px' border-left='.25' border-right='.25' >" + Customer + "</td>" +
                    "</tr>" +
                    "<tr>" +
                    "<td style='font-size:7px' border-left='.25' border-right='.25' border-top='.25' >LESSEE (Authorized Agent or as Individual) &amp; Co-Signer SIGNATURE </td>" +
                    "</tr>" +
                    "<tr height ='14'>" +
                    "<td style='font-size:11px' border-left='.25' border-right='.25' ></td>" +
                    "</tr>" +
                    "<tr>" +
                    "<td style='font-size:8px' border-left='.25' border-right='.25' border-top='.25' padding-left='62px' > DATE </td>" +
                    "</tr>" +
                    "<tr>" +
                    "<td style='font-size:11px' border-left='.25' border-right='.25' border-bottom='.25' padding-left='62px' >" + currentdate + "</td>" +
                    "</tr>" +
                    "<tr>" +
                    "<td style='font-size:5px' padding-top='-43' >DocuSignedBy</td>" +
                    "</tr>" +
                    "<tr>" +
                    "<td style='font-size:5px' padding-top='-27' >0VGDT2536BGJHYTYT</td>" +
                    "</tr>" +
                    "</table>";
                ...
                Html += "<table style='font-size:12px' align='center' width='95%' padding-top='5' >" +
                    "<tr>" +
                    "<td >" +
                    "Regularly and properly maintaining your leased vehicle is the best way to protect the Lessee's investment and is essential to your " +
                    "safety and is required under the terms of this lease agreement. Lessee will always maintain the truck in good working order and " +
                    "condition and will make all the necessary repairs to maintain the truck in safe working condition. Lessee will pay all expenses for " +
                    "truck use and operation, including but not limited to maintenance, repair, fluids, tires, and other expenses. At the Lessee's expense, " +
                    "you will have the truck serviced in accordance with LRM Leasing's minimum requirements listed below or as modified by LRM Leasing. " +
                    "You will be responsible to provide proof that such services have been performed by emailing all receipts and records to " +
                    "Maintenance@LRMLeasing.com. LRM Leasing may request detailed records from time to time at their own discretion. If records are " +
                    "not provided within 72 hours' of request or if the Lessee doesn't comply with these terms, provide the necessary documentation, " +
                    "and or meet the minimum maintenance guidelines set below; this will result in a default under the Lease Agreement and would need " +
                    "to be cured by Lessee in less than 5 business days. <br/>" +
                    "The Lessee is responsible for ensuring the vehicle is regularly and properly maintained by adhering to LRM Leasing's minimum " +
                ...
                Html += "<table style='font-size:14px' align='center' width='95%' padding-top='20px' >" +
                    "<tr>" +
                    "<td  align='left'><b>MINIMUM MAINTENANCE Requirements:</b></td>" +
                    "</tr>" +
                    "</table>";
                ...
                Html += "<table style='font-size:13px' align='center' width='95%' padding-top='20px'>" +
                    "<tr>" +
                    "<td>Oil change every 13,000 miles or less, must be performed at a verifiable truck stop or truck repair facility. x____________</td>" +
                    "</tr>" +
                    "<tr>" +
                    "<td style='font-size:4px' padding-top='-25' padding-right='60' align='right'>DS</td>" +
                    "</tr>" +
                    "</table>";

                Html += "<table style='font-size:13px' align='center' width='95%' padding-top='20px'>" +
                    "<tr>" +
                    "<td>Every 6 months the following need to be replaced</td>" +
                    "</tr>" +
                    "</table>";
                Html += "<table style='font-size:13px' align='center' width='95%' padding-top='10px' padding-left='20px'>" +
                    "<tr>" +
                    "<td><ul>" +
                    "<li>Engine air filter____________ Lessee Initials</li>" +
                    "</ul></td>" +
                    "</tr>" +
                    "<tr>" +
                    "<td style='font-size:4px' padding-top='-18' padding-left='100' align='left'>DS</td>" +
                    "</tr>" +
                    "<tr>" +
                    "<td><ul>" +
                    "<li>Cabin air filter____________ Lessee Initials</li>" +
                    "</ul></td>" +
                    "</tr>" +
                    "<tr>" +
                    "<td style='font-size:4px' padding-top='-18' padding-left='100' align='left'>DS</td>" +
                ...
                Html += "<table style='font-size:13px' align='center' width='95%' padding-top='20px'>" +
                    "<tr>" +
                    "<td>Every 12 months or 100k miles the following need to be cleaned or replaced</td>" +
                    "</tr>" +
                    "</table>";
                ...
                Html += "<table style='font-size:13px' align='center' width='95%' padding-top='10px' padding-left='20px'>" +
                    "<tr>" +
                    "<td><ul>" +
                    "<li>Replace air filter cartridge on the air system compressor ________________ Lessee Initials</li>" +
                    "</ul></td>" +
                    "</tr>" +
                    "<tr>" +
                    "<td style='font-size:4px' padding-top='-18' padding-left='280' align='left'>DS</td>" +
                    "</tr>" +
                    "<tr>" +
                    "<td><ul>" +
                    "<li>Replace DEF pump filter____________ Lessee Initials</li>" +
                    "</ul></td>" +
                    "</tr>" +
                    "<tr>" +
                    "<td style='font-size:4px' padding-top='-18' padding-left='140' align='left'>DS</td>" +
                    "</tr>" +
                    "<tr>" +
                    "<td><ul>" +
                    "<li>Replace crankcase filter ________________ Lessee Initials</li>" +
                    "</ul></td>" +
                    "</tr>" +
                    "<tr>" +
                    "<td style='font-size:4px' padding-top='-18' padding-left='120' align='left'>DS</td>" +
                    "</tr>" +
                    "<tr>" +
                    "<td><ul>" +
                    "<li>Clean diesel particulate (DPF) filters____________ Lessee Initials</li>" +
                    "</ul></td>" +
                    "</tr>" +
                    "<tr>" +
                    "<td style='font-size:4px' padding-top='-18' padding-left='200' align='left'>DS</td>" +
                    "</tr>" +
                    "</table>";
                ...
                Html += "<table style='font-size:13px' align='center' width='95%' padding-top='20px'>" +
                    "<tr>" +
                    "<td>Water is always FORBIDDEN to be used in place of coolant and or antifreeze.____________Lessee Initials</td>" +
                    "</tr>" +
                    "<tr>" +
                    "<td style='font-size:4px' padding-top='-18' padding-left='370' align='left'>DS</td>" +
                    "</tr>" +
                    "</table>";
                ...
                Html += "<table style='font-size:13px' align='center' width='95%' padding-top='10px' padding-left='20px'>" +
                    "<tr>" +
                    "<td><ul>" +
                    "<li>Be returned to LRM Leasing within three calendar days of delivery (day you take delivery is considered day one).Lessee Initials________________ </li>" +
                    "</ul></td>" +
                    "</tr>" +
                    "<tr>" +
                    "<td style='font-size:4px' padding-top='-18' padding-left='70' align='left'>DS</td>" +
                    "</tr>" +
                    "<tr>" +
                    "<td><ul>" +
                    "<li>Have less than 1,000 miles on the odometer from the time of purchase. Lessee Initials____________</li>" +
                    "</ul></td>" +
                    "</tr>" +
                    "<tr>" +
                    "<td style='font-size:4px' padding-top='-18' padding-left='395' align='left'>DS</td>" +
                    "</tr>" +
                    "</table>";
                ...
                Html += "<table style='font-size:13px' align='center' width='95%' padding-top='20px'>" +
                    "<tr>" +
                    "<td>" +
                    "*** Exchanges must be made by 4:00 PM eastern standard time on or before the third day. If the third day is a Sunday" +
                    "or holiday or a day that LRM is not open, you must return the vehicle by 10:00 AM eastern standard time the following " +
                    "business day. Vehicles with any damage or modification from the original delivery date will be ineligible for exchange. " +
                    "Vehicle must be returned to the location customer originally took delivery from. Any type of fraud or illegal activity on " +
                    "behalf of the consumer renders the LRM Leasing Exchange Policy null and void. Accessories of any kind shall remain " +
                    "with and a part of the motor vehicle. If a vehicle of greater value is desired for the exchange, customer is responsible for " +
                    "paying additional cost. Please not this is not a refund policy, but a vehicle exchange policy.Lessee Initials:__________ " +
                    "</td>" +
                    "</tr>" +
                    "<tr>" +
                    "<td style='font-size:4px' padding-top='-18' padding-left='325' align='left'>DS</td>" +
                    "</tr>" +
                    "</table>";
                ...
                Html += "<table style='font-size:12px' align='center' width='95%' padding-top='10px'>" +
                    ...
                    "executed the instrument, and that such individual made such appearance before the undersigned in the City of " +
                    ", State of Florida." +
                    "</td></tr>" +
                    "</table>";
                ...
                Html += "<table style='font-size:14px' align='center' width='95%' padding-top='10px' >" +
                    "<tr>" +
                    "<td  align='left'><b><u>If youhave yourOWNAUTHORITY:</u></b></td>" +
                    "</tr>" +
                    "</table>";
                ...
                Html += "<table style='font-size:14px' align='center' width='95%' padding-top='10px' >" +
                    "<tr>" +
                    "<td  align='left'><b><u>If youareworkingfor a company:</u></b></td>" +
                    "</tr>" +
                    "</table>";
                ...
                Html += "<table style='font-size:14px' align='center' width='95%' padding-top='10px' >" +
                    "<tr>" +
                    "<td  align='left'>IF YOU DO NOT HAVE YOUR OWN AUTHORITY YOU ARE REQUIRED TO HAVE THIRD PARTY INSURANCE AT ALL TIMES!<b> WE WILL NOT ACCEPT INSURANCE FOR THE COMPANY YOU ARE WORKING FOR!</b> <br/><br/>Any Violation of the above can result in the negation of the signed Purchase Option.</td>" +
                    "</tr>" +
                    "</table>";
                ...
                Html += "<table style='font-size:9px' align='left' width='95%' padding-top='10px' >" +
                    "<tr>" +
                    "<td  >" +
                    " <b>Lessee(s) Names:</b> <u>" + Customer + "</u> <b>Date:</b> <u>" + currentdate + "</u> " +
                    "</td>" +
                    "</tr>" +
                    "</table>";
                ...
                Html += "<table style='font-size:9px' align='left' width='95%' padding-top='10px' >" +
                    "<tr>" +
                    "<td  >" +
                    " <b>Vehicle Description:</b> __________________________________________________________________" +
                    "</td>" +
                    "</tr>" +
                    "</table>";
                Html += "<table style='font-size:9px' align='left' width='95%' padding-top='10px' >" +
                ...
                Html += "<table style='font-size:9px' align='left' width='95%' padding-top='10px' >" +
                    "<tr>" +
                    "<td  >" +
                    "<b>Vehicle Identification Number(VIN):</b> <u>" + VinNo + "</u>" +
                    "</td>" +
                    "</tr>" +
                    "</table>";
                ...
                Html += "<table style='font-size:9px' align='left' width='95%' padding-top='10px' >" +
                    "<tr>" +
                    "<td  >" +
                    "<b>The Device installed in the Vehicle has (check as applicable): X GPS X Starter Interrupt.</b> Please see a summary of terms of this Agreement below." +
                    "</td>" +
                    "</tr>" +
                    "</table>";

                Html += "<table style='font-size:9px' align='left' width='95%' padding-left='20px' >" +
                    "<tr>" +
                    "<td ><ul>" +
                ...
                Html += "<table style='font-size:12px' align='left' width='95%' padding-top='25px' >" +
                    "<tr>" +
                    "<td  >" +
                    " Lessee(s) Names <u>" + Customer + "</u>" +
                    "</td>" +
                    "<td  >" +
                    ...
                    "</tr>" +
                    "<tr>" +
                    "<td style='font-size:4px' padding-top='-18' padding-left='100' align='left'>DocuSignedBy</td>" +
                    "</tr>" +
                    "<tr>" +
                    "<td style='font-size:4px' padding-top='-4' padding-left='100' align='left'>uiuhekjh987656</td>" +
                    "</tr>" +
                    "<tr padding-top='25px'>" +
                    "<td  >" +
                    " Co-lessee(s) ________________________________________________" +
                    "</td>" +
                    "<td  >" +
                    " Date:<u>" + currentdate + "</u> " +
                    "</td>" +
                ...
                Html += "<table style='font-size:13px' align='center' width='95%' padding-top='10px' >" +
                    "<tr>" +
                    "<td>" +
                    "Unpaid tolls sometimes occur, though, usually because your vehicle's payment transponder fails at a toll lane, or you do " +
                ...
                Html += "<table style='font-size:13px' align='center' width='95%' padding-top='10px' >" +
                    "<tr>" +
                    "<td>" +
                    "<b>Avoid these typical issues</b>" +
                    "</td>" +
                    "</tr>" +
                    "</table>";
                ...
                Html += "<table style='font-size:13px' align='center' width='95%' padding-top='10px' >" +
                    "<tr>" +
                    "<td>" +
                    "Transponder: It is imperative that you have a transponder properly set up. Your transponder must: 1) be compatible " +
                    ...
                    "Inactive plates: Any time you either renew your registration, get a new plate, switch carriers, or cause any other event " +
                ...
                Html += "<table style='font-size:12px' align='center' width='95%' padding-top='20px' >" +
                    "<tr>" +
                    "<td>" +
                    "<b>LRM reserves the right, in its sole discretion, to change and replace FleetIT with any other similar service provider. Furthermore, " +
                    "LRM reserves the right, in its sole discretion, to choose to no longer use the services of FleetIT or any other similar service provider.</b> " +
                    "</td>" +
                    "</tr>" +
                    "</table>";
                ...
                Html += "<table style='font-size:9px' align='center' width='95%' padding-top='10px' >" +
                    "<tr>" +
                ...
                Html += "<table   style='font-size:11px' align='center'  padding-top='10px' width='65%' >" +
                    "<tr>" +
                    "<td   style='font-size:9px'><b>Make</b></td><td   style='font-size:9px'>" + Brand + "</td><td   style='font-size:9px'><b>Year</b></td><td   style='font-size:9px'>" + Year + "</td><td  style='font-size:9px'><b>Vin</b></td><td   style='font-size:9px'>" + VinNo + "</td>" +
                    "</tr>" +
                    "</table>";
                ...
                Html += "<table  style='font-size:11px' align='center'  padding-top='10px' width='95%' >" +
                    ...
                    "<td  align='right'><b>Return Fee:$ ___________</b></td>" +
                    "</tr>" +
                    "</table>";
                ...
                Html += "<table align='center'  padding-top='10px' width='95%' >" +
                    "<tr>" +
                    "<td>" +
                    "<table align ='left'>" +
                    "<tr>" +
                    "<td style='font-size:14px'><b>LEESOR:</b></td>" +
                    "</tr>" +
                    "<tr>" +
                    "<td style='font-size:11px'>By:<u></u></td>" +
                    "</tr>" +
                    "<tr>" +
                    "<td style='font-size:4px' padding-top='-18' padding-left='40' align='left'>DocuSignedBy</td>" +
                    "</tr>" +
                    "<tr>" +
                    "<td style='font-size:4px' padding-top='-4' padding-left='40' align='left'>uiuhekjh987656</td>" +
                    "</tr>" +
                    "<tr>" +
                    "<td style='font-size:11px'>Name:<u></u></td>" +
                    "</tr>" +
                    "<tr>" +
                    "<td style='font-size:11px'>Title:<u>Director</u></td>" +
                    "</tr>" +
                    "</table>" +
                    "</td>" +
                    "<td>" +
                    "<table align='right' padding-right='100'>" +
                    "<tr>" +
                    "<td style='font-size:14px'><b>LEESE:</b></td>" +
                    "</tr>" +
                    "<tr>" +
                    "<td style='font-size:11px'>By:<u></u></td>" +
                    "</tr>" +
                    ...
                    "</tr>" +
                    "<tr>" +
                    "<td style='font-size:11px'>Name:<u>" + Customer + "</u></td>" +
                    "</tr>" +
                    "<tr>" +
                    "<td style='font-size:11px'>Title:<u>Director</u></td>" +
                    "</tr>" +
                ...
                Html += "<table align='left' width='95' padding-top='10'  padding-left='60'>" +
                    "<tr>" +
                    "<td style='font-size:13px'><b>LEESE:</b></td><td></td>" +
                    "</tr>" +
                    "</table>";

                Html += "<table align='center' width='75%'  padding-left='60' >" +
                    "<tr>" +
                    "<td style='font-size:13px' ><b>By:</b></td><td>_______________</td>" +
                    "</tr>" +
                    "<tr>" +
                    "<td></td><td style='font-size:4px' padding-top='-18' padding-left='40' align='left'>DocuSignedBy</td>" +
                    "</tr>" +
                    "<tr>" +
                    "<td></td><td style='font-size:4px' padding-top='-4' padding-left='40' align='left'>uiuhekjh987656</td>" +
                    "</tr>" +
                    "<tr>" +
                    "<td style='font-size:13px' ><b>Printed Name:</b></td><td><u>" + Customer + "</u></td>" +
                    "</tr>" +
                    "<tr>" +
                    "<td style='font-size:13px' ><b>Title:</b></td><td><u>Director</u></td>" +
                    "</tr>" +
                    "<tr>" +
                    "<td style='font-size:13px' ><b>Odometer Reading:</b></td><td>______________</td>" +
                    "</tr>" +
                    "</table>";

                Html += "<table style='font-size:13px' align='left' width='95%' padding-top='20px' >" +
                    "<tr>" +
                    "<td padding-left='20' >Accepted by Lessor:</td>" +
                    "</tr>" +
                    "</table>";

                Html += "<table style='font-size:13px' align='left' width='95%' padding-top='20px' >" +
                    "<tr>" +
                    "<td padding-left='20' ><b>LRM Leasing Company, Inc.</b></td>" +
                    "</tr>" +
                    "</table>";

                Html += "<table align='left' padding-left='20' padding-top='30' >" +
                    "<tr>" +
                    "<td style='font-size:11px'>By:______________</td>" +
                    "</tr>" +
                    "<tr>" +
                    "<td style='font-size:4px' padding-top='-18' padding-left='40' align='left'>DocuSignedBy</td>" +
                    "</tr>" +
                    ...
                    "</tr>" +
                    "<tr>" +
                    "<td style='font-size:11px'>Its:<u>"+Customer+"</u></td>" +
                    "</tr>" +
                    "<tr>" +
                    "<td style='font-size:11px'>date:<u>" + currentdate + "</u></td>" +
                    "</tr>" +
                    "</table>";
                ...
                Html+="<table align='center'>" + // style='margin-left:20px'   height='7'
                "<tr><td>&nbsp;</td></tr>"+
                "<tr >" +
                " <td width='100%'><img src ='" + Imagewith1980 + "' align='center' width='130px' height='75px' margin-top='8px' alt='Logo cannot loaded'></img></td>" +
                "</tr>" +
                "</table>" ;

                Html += "<table style='font-size:13px' align='center' width='95%' padding-top='20px' >" +
                    "<tr>" +
                    "<td  align='center'><b>Maintenance Repair Price Sheet</b></td>" +
                    "</tr>" +
                    "</table>";
                Html += "<table style='font-size:13px' align='center' width='95%' padding-top='5px' >" +
                    "<tr>" +
                    "<td  align='center'><b>* For informational purposes only</b></td>" +
                    "</tr>" +
                    "</table>";

                Html += "<table style='font-size:13px' align='center' width='90%' padding-top='15px' >" +
                    "<tr>" +
                    "<td  >" +
                    "All costs are an approximation and in no way to be used for quoting purposes. Prices can be higher or " +
                    "lower depending on the vendor performing the work. The information below is intended for " +
                ...
                Html += "<table style='font-size:13px' align='center' width='90%' padding-top='15px' >" +
                    "<tr>" +
                    "<td  align='center'><b>MOST COMMON MAINTENANCE EXPENSES TO BE PREPARED FOR INCLUDE BUT ARE NOT LIMITED TO:</b></td>" +
                    "</tr>" +
                    "</table>";

                Html += "<table style='font-size:13px' align='center' width='90%' padding-top='15px' >" +
                    "<tr>" +
                    "<td  align='center'>Oil changes, Filters, Tires, Belts, Sensors, Fuses, Air hoses, Coolant hoses, Tensioners, Pulleys, Seals, and O-rings, air leaks, fifth wheel (springs)</td>" +
                    "</tr>" +
                    "</table>";
                ...
                Html += "<table style='font-size:13px' align='center' width='90%' padding-top='15px' >" +
                    "<tr>" +
                    "<td  align='center'><b>MORE EXPENSIVE MAINTENANCE EXPENSES TO BE PREPARED FOR INCLUDE BUT ARE NOT LIMITED TO:</b></td>" +
                    "</tr>" +
                    "</table>";

                Html += "<table style='font-size:13px' align='center' width='90%' padding-top='15px' >" +
                    "<tr>" +
                    "<td  ><b>*Prices are inclusive of estimated parts and labor.</b></td>" +
                    "</tr>" +
                    "</table>";

                Html += "<table style='font-size:13px' align='center' width='90%' padding-top='15px' >" +
                    "<tr>" +
                    "<td  ><b>Radiator:</b>$3,000-$4,000 approximately</td>" +
                    "</tr>" +
                    "</table>";
                Html += "<table style='font-size:13px' align='center' width='90%' padding-top='15px' >" +
                    "<tr>" +
                    "<td  ><b>Turbo:</b>$2,600—$4,900 approximately</td>" +
                    "</tr>" +
                    "</table>";
                Html += "<table style='font-size:13px' align='center' width='90%' padding-top='15px' >" +
                    "<tr>" +
                    "<td  ><b>Transmission:</b>Automatic- $14,000 approximately Manual- $ 5,200 approximately</td>" +
                    "</tr>" +
                    "</table>";

                Html += "<table style='font-size:13px' align='center' width='90%' padding-top='15px' >" +
                    "<tr>" +
                    "<td  ><b>Clutch:</b>$2,000-$4,000</td>" +
                    "</tr>" +
                    "</table>";
                Html += "<table style='font-size:13px' align='center' width='90%' padding-top='15px' >" +
                    "<tr>" +
                    "<td  ><b>EGR cooler/valve:</b>$1,900-$2,500 approximately</td>" +
                    "</tr>" +
                    "</table>";
                Html += "<table style='font-size:13px' align='center' width='90%' padding-top='15px' >" +
                    "<tr>" +
                    "<td  ><b>After treatment system: Sensors:</b>$1,000-$1200 approximately <b>DPF filters:</b>$1200-$1900 <b>DOC filters:</b>  $5700-$11,000 approximately</td>" +
                    "</tr>" +
                    "</table>";
                Html += "<table style='font-size:13px' align='center' width='90%' padding-top='15px' >" +
                    "<tr>" +
                    "<td  ><b>Injectors:</b>$400-500 (EACH)</td>" +
                    "</tr>" +
                    "</table>";
                Html += "<table style='font-size:13px' align='center' width='90%' padding-top='15px' >" +
                    "<tr>" +
                    "<td ><b>Computer modules:</b></td>" +
                    "</tr>" +
                    "</table>";
                Html += "<table style='font-size:13px' align='center' width='90%' padding-top='15px' >" +
                    "<tr>" +
                    "<td  ><b>MCM:</b>$1,200-$2,200 <b>ECM:</b>$1,200-$2,200 <b>ACM:</b>$800-$2300 <b>PNDB:</b>$400-$600 <b>TCM:</b>$1,200-$2,300</td>" +
                    "</tr>" +
                    "</table>";



                Html += "<table style='font-size:13px' align='center' width='90%' padding-top='20px' >" +
                    "<tr>" +
                    "<td>By initialing, you acknowledge that you have read this document in its entirety x_________</td>" +
                    "</tr>" +
                    "<tr>" +
                    "<td style='font-size:4px' padding-top='-18' padding-left='365'>DS</td>" +
                    "</tr>" +
                    "</table>";
                ...
                "<tr><td>&nbsp;</td></tr>"+
                "<tr >" +
                " <td width='100%'><img src ='" + Imagewith1980 + "' align='center' width='140px' height='80px' margin-top='8px' alt='Logo cannot loaded'></img></td>" +
                "</tr>" +
                "</table>" ;
                ...
                Html += "<table style='font-size:13px' align='center' width='85%' padding-top='20px' >" +
                    "<tr>" +
                    "<td  align='left'><b>Section 2: Payment Information</b></td>" +
                    "</tr>" +
                    "</table>";
                ...
                Html += "<table style='font-size:13px' align='center' width='85%' padding-top='10px' >" +
                    "<tr>" +
                    "<td  align='left'>" +
                    "I <u>" + Customer + "</u> authorize LRM to charge my bank account indicated above for the amount, " +
                    "frequency, and date under the “Term and Payment Schedule” of your Motor Vehicle Lease Agreement. " +
                    "In the event that additional amounts are due under the Motor Vehicle Lease Agreement such as, but " +
                    "not limited to, prior failed ACH drafts, non-sufficient funds fees, collateral protection fees, personal " +
                    "property taxes, late fees, and any other charges that may be assessed and owed to LRM; I authorize " +
                    "LRM to make changes to the amount or frequency being drafted. " +
                    "</td>" +
                    "</tr>" +
                    "</table>";
                ...
                Html += "<table style='font-size:13px' align='center' width='85%' padding-top='20px' >" +
                    "<tr>" +
                    "<td  align='left'><b>Section 3: Signature</b></td>" +
                    "</tr>" +
                    "</table>";
                ...
                Html += "<table style='font-size:13px' align='center' width='85%' padding-top='10px' >" +
                    "<tr>" +
                    "<td  align='left'>" +
                    "By signing below, I acknowledge that I have reviewed the Automatic Debit Authorization Terms &amp; " +
                    "Conditions. I further authorize LRM to initiate debit entries to the financial institution defined in " +
                    "Section 1 of this form for the amount specified in Section 2, including but not limited to, any past due " +
                    "payments, fees, or other charges to your account. I understand that this authorization will remain in " +
                    "effect until (1) all payments required by the Lease Agreement have been satisfied or (2) LRM receives " +
                    "notification from me and LRM approves to revoke this authorization. I also understand that LRM may " +
                    "at its discretion attempt to process the charge again within 5 days and agrees to the additional fees " +
                    "because of prior rejected failed ACH transactions. I acknowledge that the origination of ACH " +
                ...
                Html += "<table style='font-size:13px' align='center' width='95%' padding-top='10px' >" +
                    "<tr>" +
                    "<td  >" +
                    "Automatic payments will begin with the next unbilled statement cycle after the completed form has " +
                    "been received. If automatic payments cannot be established for any reason, such as an incorrect " +
                    "routing number, LRM will contact you to discuss the issue. This may cause a delay in your automatic " +
                    "payments. You will still be responsible to make any billed payments until the automatic payments have " +
                    "been established.<br/><br/>" +
                    "If the lease payment due date falls on a weekend or holiday, payments will be executed on the " +
                ...
                Html += "<table style='font-size:13px' align='center' width='95%'  >" +
                    "<tr>" +
                    "<td  >" +
                    "If, for any reason, LRM is unable to deduct payments from your account, you are still required to remit " +
                    "your monthly payment amount.You will receive notification that the automatic debit failed and are " +
                    "responsible for making any past due payments, including any and all fees and taxes.Returned " +
                    "payments will result in a $50 charge(subject to change at LRM's discretion at any point during the " +
                    "Lease Agreement) and 10 % late fee charge assessment on your lease account if payment is not " +
                    "received by the end of the grace period as outlined in your Motor Vehicle Lease Agreement.Late " +
                    "charges and other fee assessments will be drafted in the next available payment due date immediately " +
                ...
                Html += "<table style='font-size:13px' align='center' width='95%'  >" +
                    ...
                    "LRM reserves the right to terminate automatic debits with notice to you.Reasons for termination " +
                    "include, but are not limited to: deposit account closure, frozen deposit account, multiple months of " +
                    "returned payments due to Non - Sufficient Funds." +
                    "</td>" +
                    "</tr>" +
                    "</table>";
                ...
                Html += "<table style='font-size:13px' align='center' width='95%' padding-top='10px' >" +
                    "<tr>" +
                    "<td align='center' ><b>Email: payments@lrmleasing.com</b></td>" +
                    "</tr>" +
                    "</table>";
                Html += "<table style='font-size:13px' align='center' width='95%' padding-top='10px' >" +
                    "<tr>" +
                    "<td align='center' ><b>Telephone:</b> (954) 791-100</td>" +
                    "</tr>" +
                    "</table>";
                ...
                Html+="<table style='font-size:13px' align='center' width='85%'>" + // style='margin-left:20px'   height='7'
                "<tr><td>&nbsp;</td></tr>"+
                "<tr>" +
                "<td align='left'><img src ='" + Imagewith1980 + "' align='left' width='200px' height='150px' margin-top='8px' alt='Logo cannot loaded'></img></td>" +
                "</tr>" +
                "</table>" ;
                Html += "<table style='font-size:13px' align='center' width='85%' padding-top='10px' >" +
                    "<tr>" +
                ...
                Html += "<table style='font-size:13px' align='center' width='85%' padding-top='20px' >" +
                    "<tr>" +
                    "<td  align='left'>" +
                    "It is understood and agreed upon that at the maturity of the lease agreement for the " +
                    "vehicle listed below that the title will be signed over in the name of: <u>" + CustomerCompany + "</u>" +
                    "</td>" +
                    "</tr>" +
                    "</table>";

                Html += "<table style='font-size:11px' align='center' width='85%' padding-top='20px' >" +
                    "<tr>" +
                    "<td  align='left'>" +
                    "Individual name, or Company on the lease agreement:" +
                    "</td>" +
                    "</tr>" +
                    "</table>";
                ...
                Html += "<table style='font-size:13px' align='center' width='85%' padding-top='40px' >" +
                    "<tr>" +
                    "<td  align='left'>" +
                    "I understand that this decision cannot be changed for any reason whatsoever x_______________" +
                    "</td>" +
                    "</tr>" +
                    "<tr>" +
                    "<td style='font-size:4px' padding-top='-18' padding-left='350' align='left'>DS</td>" +
                    "</tr>" +
                    "</table>";

                Html += "<table style='font-size:13px' align='center' width='55%' padding-top='50px' >" +
                    "<tr>" +
                    "<td>Year:</td><td>" + Year + "</td><td>Make:</td><td>" + Brand + "</td>" +
                    "</tr>" +
                    "</table>";
                ...
                for (var i = 0; i < VIN.length; i++) {
                    ...
                    if (i == 0) {
                        Html += "<td  align='center'  border-collapse = 'collapse'    border-bottom ='.25'  border-right ='.25' border-top ='.25' border-left ='.25' >" + VIN[i] + "</td>";
                    } else {
                        Html += "<td  align='center'  border-collapse = 'collapse'    border-bottom ='.25'  border-right ='.25' border-top ='.25' >" + VIN[i] + "</td>";
                    }
			...
			context.response.write(onclickScript);
					...
					/* var onclickScript='';
					onclickScript+="debugger;var dd_i ="+dd_i+";";
					onclickScript+=" <html><body> <script type='text/javascript'>";
					onclickScript+="window.open('https://8760954.app.netsuite.com/app/common/custom/custrecordentry.nl?id="+dd_i+"&rectype=953&whence=');";
					onclickScript+="</script></body></html>";
					context.response.write(onclickScript);		 */
				}catch(e)
				{
