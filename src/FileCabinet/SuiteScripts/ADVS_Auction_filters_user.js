...
function suitelet(request, response){
    ...
    if(request.getMethod()=='GET'){
        ...
        try{
            ...
            var form = nlapiCreateForm('Auction Sheet', false);
            var fil = [];
            var col = [];
...
//					var cat1='';
                    ...
                    str = str.replace("{1}"," 'auctionsheet' ");
                    str = str.replace("{2}",i);
            ...
            nlapiSetRedirectURL('SUITELET', 'customscript_auction_dashboard_sheet', 'customdeploy_auction_dashboard_sheet', null, Param);
