...
define(['N/search'],
    ...
    function(search) {
        ...
        function saveRecord(scriptContext) {
			var currentRecord =scriptContext.currentRecord ;
			var vin = currentRecord.getValue({fieldId:'custpage_vin'});
			if(vin)
			{
				var _year = search.lookupFields({type:'customrecord_advs_vm',id:vin,columns:['custrecord_advs_vm_model_year']});
				if(_year.custrecord_advs_vm_model_year.length)
				{
					_year.custrecord_advs_vm_model_year[0].value
				}else{
