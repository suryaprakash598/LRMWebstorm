...
function suitelet(request, response){
    ...
    if(request.getMethod()=='GET'){
        ...
        try{
            ...
            var form = nlapiCreateForm('Repossession Sheet', false);
            var fil = [];
            var col = [];

            fil.push(new nlobjSearchFilter('internalid', null, 'is', _empid));
            col.push(new nlobjSearchColumn('custentity_repo_filters_chosen'));
...
//					var cat1='';
                    ...
                    str = str.replace("{1}"," 'repossessionsheet' ");
                    str = str.replace("{2}",i);
            ...
            nlapiSetRedirectURL('SUITELET', 'customscript_repossession_dashboard_shee', 'customdeploy_repossession_dashboard_shee', null, Param);
