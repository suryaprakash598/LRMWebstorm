...
define(['N/currentRecord', 'N/runtime', 'N/url', 'N/https', 'N/record'],
    ...
    function (currentRecord, runtime, url, https, record) {
        ...
        function fieldChanged(scriptContext) {
            ...
            if (FieldName == "custpage_buucket") {

                var LabTab = CurrentRecord.getValue({
                    fieldId: FieldName
                });
                var EmailTemp = CurrentRecord.getValue({
                    fieldId: "custpage_emailtemp"
                });
                ...
                var URL = url.resolveScript({
                    ...
                    params: {
                        "custparam_labtab": LabTab,
                        "custparam_emailtemp": EmailTemp,
                        "ifrmcntnr": "T"
                    }
                });
